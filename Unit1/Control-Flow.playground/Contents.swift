...
if temperature < 45 { // scope of if block is within curly bracket { ... }
    ...
    if temperature == 0 { // nested if statments
        print("I'm dead")
        // danger zone approaching pyramid of death ☠️
        //        if {
        //            if {
        //                if {
        //                    if {
    ...
    print("the temperrature for today is \(temperature)")
}
...
print(age > 20 ? "you can have that drink 🍺" : "get back to Grandm's hours")
...
case "web":
    ...
    print("python 🐍 is cool") // DRY - do not repeat yourself
...
case 2..<3:
    print("It's 2015 and Objective-C is still the keading language to write iOS apps")
case 3..<4:
    print("2016")
case 4..<5:
    print("2017")
...
let kim = (age: 19, cochor: 6.1, passion: "music")
let heather = (age: 23, cochor: 6.4, passion: "immigration rights")
let nancy = (age: 34, cochor: 6.3, passion: "video games")
...
case(_,6.3,_):
    print("iOS is still awsome!!!")
case(_,_,"video games"):
    print("see you at Pursuits Game night, bring the drinks")
default:
